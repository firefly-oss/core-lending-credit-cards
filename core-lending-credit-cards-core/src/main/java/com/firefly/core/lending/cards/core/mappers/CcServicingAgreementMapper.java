...
public interface CcServicingAgreementMapper {
    CcServicingAgreementDTO toDTO(CcServicingAgreement entity);
    CcServicingAgreement toEntity(CcServicingAgreementDTO dto);
}
